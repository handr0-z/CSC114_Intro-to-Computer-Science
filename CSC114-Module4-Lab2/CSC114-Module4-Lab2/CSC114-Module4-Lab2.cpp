...
//  Deliverables:               Module #4, Lab #2
//  Date:                       2/03/2025
//  Attributions:               Simple cookie recipe program created to calculate required ingredients for cookies.
//  CSC114-Module4-Lab2.cpp:    This file contains the 'main function. Program executions beings and ends there.
//----------------------------------------------------------------------------------------------------------------------
...
{   // Introduce the program and the purpose to the end user.
    cout << " (Module #4 Lab #2: if, else if, if statements) \n\n";
    ...
    // Confirm # cookies desired with end user to calculate quantities from list provided below.
    ...
    if (optionMenu == int('A'))
        cookiesDesired = 5;
    else if (optionMenu == int('B'))
        cookiesDesired = 10;
    else if (optionMenu == int('C'))
        cookiesDesired = 15;
    else if (optionMenu == int('D'))
        cookiesDesired = 20;
    else if (optionMenu == int('E'))
    {
        cout << "\nDesired number of cookies: ";
        cin >> cookiesDesired;
    }
    else if ((optionMenu != int('A') || int('B') || int('C') || int('D') || int('E')))
    {
    ...
    // Message to user if invalid number provided.
    if (cookiesDesired <= 0)
    {
