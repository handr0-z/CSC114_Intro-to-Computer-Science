...
//  Deliverables:                       Module #5, Assignment 2
//  Date:                               02/12/2025
//  Attributions:                       Program created to convert US, Canadian, & Japanese Currency
//  CSC114-Module5-Assignment2.cpp:     This file contains the 'main function. Program executions beings and ends there.
//----------------------------------------------------------------------------------------------------------------------------
...
int main()
{
    ...
    cout << "Module #5 Assignment #2: For Loop\n";
    cout << "-----------------------------------------------------------------------------------------\n";
    ...
    for (int i = 0; i <= (maxValue / incrementValue); i++)
    {
