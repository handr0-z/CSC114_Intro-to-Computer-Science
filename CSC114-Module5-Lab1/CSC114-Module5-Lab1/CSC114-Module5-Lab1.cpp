...
//  Deliverables:               Module #5, Lab #1
//  Date:                       02/10/2025
//  Attributions:               Simple cookie recipe program created to calculate required ingredients for cookies.
//  CSC114-Module5-Lab1.cpp:    This file contains the 'main function. Program executions beings and ends there.
//----------------------------------------------------------------------------------------------------------------------
...
{   // Introduce the program and the purpose to the end user.
    cout << "         (Module #5 Lab #1: While Loop)         \n\n";
    ...
    do
    {
        ...
        } while (optionMenu != int('A') && optionMenu != int('a') && optionMenu != int('B') && optionMenu != int('b') && optionMenu != int('C') && optionMenu != int('c') && optionMenu != int('D') && optionMenu != int('d') && optionMenu != int('E') && optionMenu != int('e'));
